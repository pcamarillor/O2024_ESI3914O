...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Repost Producer Kafka arguments")
    parser.add_argument(
    ...
    try:
        ...
        while True:
            message_data = {
                ...
                "original_post_id": random.randint(1, 500),
                "comment": generate_random_words(),
            }
